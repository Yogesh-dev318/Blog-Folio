    ...
    return <div>
        ...
        <div className="flex justify-center w-full pt-8"> 
            <div className="max-w-screen-lg w-full">
                ...
                }} type="submit" className="mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-green-700 rounded-lg focus:ring-4 focus:ring-green-200 dark:focus:ring-green-900 hover:bg-green-800">
                    Publish post
                </button>
            </div>
        </div>
